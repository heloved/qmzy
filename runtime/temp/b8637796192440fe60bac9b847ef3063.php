<?php /*a:2:{s:77:"E:\PHPStudy\PHPTutorial\WWW\qmzy5139\application\index\view\resource\web.html";i:1574672817;s:78:"E:\PHPStudy\PHPTutorial\WWW\qmzy5139\application\index\view\public\footer.html";i:1574690306;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body style="background-color: #f0f0f0;">
        ...
        <div class="heloved-header layui-header">
            ...
            <ul class="header-nav" id="header-nav">
                ...
                <li class="layui-nav-item  header-nav-this"><a href="<?php echo url('index/resource/web'); ?>">WEB前端</a></li>
        ...
        <div class="wrap_box_content">
            ...
            <div class="content_content clearfix">
                <ul class="resource-list">
                    ...
                    <li>
                        <a href="http://47.106.86.207/190108_html/5" target="_blank">
                            <img alt="个人网站" height="168" width="100%" src="http://47.106.86.207/190106_message/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>HTML5</i>个人网站</h3>
                                <p>HTML5新功能表单、音频、视频、存储</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-green">2019-01-08</span></span>
                    ...
                    <li>
                        <a href="http://47.106.86.207/190108_html/4" target="_blank">
                            <img alt="个人网站" height="168" width="100%" src="http://47.106.86.207/190106_message/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>HTML5</i>个人网站</h3>
                                <p>HTML5新功能表单、音频、视频、存储</p>
                    ...
                    <li>
                        <a href="http://47.106.86.207/190108_html/2" target="_blank">
                            <img alt="个人网站" height="168" width="100%" src="http://47.106.86.207/190106_message/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>HTML5</i>个人网站</h3>
                                <p>HTML5新功能表单、音频、视频、存储</p>
                    ...
                    <li>
                        <a href="http://47.106.86.207/190108_html/1" target="_blank">
                            <img alt="个人网站" height="168" width="100%" src="http://47.106.86.207/190106_message/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>HTML5</i>个人网站</h3>
                                <p>HTML5新功能表单、音频、视频、存储</p>
