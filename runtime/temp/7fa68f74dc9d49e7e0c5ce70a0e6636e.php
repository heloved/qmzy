<?php /*a:2:{s:79:"E:\PHPStudy\PHPTutorial\WWW\qmzy5139\application\index\view\resource\index.html";i:1574672823;s:78:"E:\PHPStudy\PHPTutorial\WWW\qmzy5139\application\index\view\public\footer.html";i:1574690306;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        <script src="http://localhost/qmzy5139/public/static/layui/layui.js"></script>
        <script src="http://localhost/qmzy5139/public/static/index/js/jquery-1.11.1.min.js"></script>
        <style type="text/css">
        ...
        <script>
            layui.use('layer', function () {
                ...
                var content = '';
                content += '<div id="tip">';
                content += "<h1>new.qimozuoye.com</h1>";
                ...
                content += "<h4>本站资源部分来源网络，仅供学习，不可商用，如果侵犯了您的权益，请联系QQ:319460833</h4>";
                content += "</div>";
                //配置一个透明的询问框
                layer.msg(content, {
                    time: 20000, //20s后自动关闭
    ...
    <body style="background-color: #f0f0f0;">
        ...
        <div class="heloved-header layui-header">
            ...
            <ul class="header-nav" id="header-nav">
                ...
                <li class="layui-nav-item header-nav-this"><a href="<?php echo url('index/resource/index'); ?>">综合资源</a></li>
                <li class="layui-nav-item"><a href="<?php echo url('index/resource/message'); ?>">留言板系统</a></li>
            ...
            <div class="heloved-user-info">
                <span class="dropbtn">heloved</span>
                <div class="dropdown">
        ...
        <div class="layui-row resource-class" id="category-list" style="display: none;">
            <div class="layui-col-md12 resource-border">
                <ul class="category-first">
                    <li class="resource-type">难度：</li>
                    <li class="resource-class-li-bg"><a href="#">全部</a></li>
                    <li><a href="#" title="初级">初级</a></li>
                    <li><a href="#" title="中级">中级</a></li>
                    <li><a href="#" title="高级">高级</a></li>

                </ul>
            </div>
            <div class="layui-col-md12 resource-border">
                <ul class="category-second">
                    <li class="resource-type">语言：</li>
                    <li class="resource-class-li-bg"><a href="javascript:;">全部</a></li>
                    <li><a href="#">PHP</a></li>
                    <li><a href="#" title="ThinkPHP3">ThinkPHP3</a></li>
                    <li><a href="#" title="ThinkPHP5">ThinkPHP5</a></li>
        ...
        <div class="wrap_box_content">
            <div class="content_title">
                <i class="layui-icon layui-icon-prev"></i> 小云云<i class="layui-icon layui-icon-next"></i>
            </div>
            <div class="content_content clearfix">
                <ul class="resource-list">
                    ...
                    <li>
                        <a href="http://47.106.86.207/message_xl/index.php/Admin" target="_blank">
                            <img alt="留言板管理系统后台" height="124" width="100%" src="http://47.106.86.207/message_xl/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP3.2.3+Bootstrap</i>留言板管理系统后台</h3>
                                <p>登录、留言管理（增删改查）</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-green">2018-12-21</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">45</span></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="http://47.106.86.207/message_xl/index.php" target="_blank">
                            <img alt="留言板管理系统前台" height="158" width="100%" src="http://47.106.86.207/message_xl/iii.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP3.2.3+Bootstrap</i>留言板管理系统前台</h3>
                                <p>首页留言列表、登录、注册、发布留言、搜索留言</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-green">2018-12-21</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">45</span></span>
                    ...
                    <li>
                        <a href="http://47.106.86.207/18_12_08_message/index.php" target="_blank">
                            <img alt="title" height="124" width="100%" src="http://47.106.86.207/18_12_08_message/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>留言板（分页、验证码）</h3>
                                <p>登录注册、验证码、留言管理（添加、分页显示、回复、删除）、回复留言列表</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-cyan">2018-12-08</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">60</span></span>
                            </div>   
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="http://47.106.86.207/18_12_19_shop/index.php" target="_blank">
                            <img alt="仿联想电脑商城-前台" height="124" width="100%" src="__UPLOAD__/resource/18-11-15_lenvo_index.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP3.2.3</i>仿联想电脑商城-前台（简单）</h3>
                                <p>首页、商品详情页，我的购物车、我的收货地址</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-orange">2018-12-19</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">50</span></span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="http://47.106.86.207/18_12_19_shop/admin.php" target="_blank">
                            <img alt="仿联想电脑商城-后台" height="124" width="100%" src="__UPLOAD__/resource/18-11-15_lenovo_admin.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP3.2.3</i>仿联想电脑商城-后台（简单）</h3>
                                <p> 管理员登录、分类管理（增删改查）、商品管理（增删改查）</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-orange">2018-12-19</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">50</span></span>
                    ...
                    <li>
                        <a href="http://47.106.86.207/18-11-15_lenovo_tp5/public/index.php" target="_blank">
                            <img alt="仿联想电脑商城-前台" height="124" width="100%" src="__UPLOAD__/resource/18-11-15_lenvo_index.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP5</i>仿联想电脑商城-前台</h3>
                                <p>首页、商品详情页，我的购物车、我的订单、我的评论、我的个人信息，我的收货地址，修改密码、</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-orange">2018-11-23</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">100</span></span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="http://47.106.86.207/18-11-15_lenovo_tp5/public/admin.php" target="_blank">
                            <img alt="仿联想电脑商城-后台" height="124" width="100%" src="__UPLOAD__/resource/18-11-15_lenovo_admin.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP5</i>仿联想电脑商城-后台</h3>
                                <p> 管理员管理、会员管理、分类管理、品牌管理、商品管理、订单管理、评论管理、 广告管理、系统管理</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-orange">2018-11-23</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">100</span></span>
                    ...
                    <li>
                        <a href="http://47.106.86.207/18_12_14_message/index.php" target="_blank">
                            <img alt="学生信息管理系统" height="168" width="100%" src="http://47.106.86.207/18_12_14_message/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>文件与目录操作</i>文本式留言板</h3>
                                <p>将留言信息存到文件里，然后读取进行操作。(留言列表，添加留言)</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge">2018-12-14</span></span>
                    ...
                    <li>
                        <a href="http://www.php.cn/linux-388083.html" target="_blank">
                            <img alt="Linux目录与文件的权限意义详解" height="168" width="100%" src="__UPLOAD__/resource/18-11-15_lenovo_admin.png">
                            <div class="intro">
                                <h3><i>linux运维</i>Linux目录与文件的权限意义详解</h3>
                                <p>Linux目录与文件的权限意义详解</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-orange">2018-03-12 10:44:31</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">0</span></span>
                            </div>
                        </a>
                    </li>

                    <li>
                        <a href="http://www.php.cn/html5-tutorial-387842.html" target="_blank">
                            <img alt="小灰灰特产" height="168" width="100%" src="http://img.php.cn/upload/course/000/000/003/5a5099080616f758.jpg" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>html5开发表白神器实现代码</h3>
                                <p>html5开发表白神器实现代码</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge">2018-03-09 10:21:40</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">0</span></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="http://www.php.cn/php-weizijiaocheng-387596.html" target="_blank">
                            <img alt="汽车功能" height="168" width="100%" src="http://img.php.cn/upload/course/000/000/003/5a5099080616f758.jpg" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>PHP中如何使用CURL</h3>
                                <p>PHP中如何使用CURL</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-cyan">2018-03-07 09:25:40</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">0</span></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="http://www.php.cn/php-weizijiaocheng-387277.html" target="_blank">
                            <img alt="音乐咖啡厅" height="168" width="100%" src="http://img.php.cn/upload/course/000/000/003/5a5099080616f758.jpg" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>php教程</i>PHP获取当前主机、域名、路径、端口等参数代码分享</h3>
                                <p> </p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-black">2018-03-01</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">0</span></span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="http://120.78.162.99/18-11-05/gxybysj/index.php" target="_blank">
                            <img alt="音乐咖啡厅" height="124" width="100%" src="http://img.php.cn/upload/course/000/000/003/5a5099080616f758.jpg" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>音乐咖啡厅</h3>
                                <p> </p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-black">2018-11-04</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">40</span></span>
                            </div>
                        </a>
                    </li>

                    <li>
                        <a href="http://120.78.162.99/18-11-03/" target="_blank">
                            <img alt="电子设备商城" height="124" width="100%" src="http://img.php.cn/upload/course/000/000/003/5a5099080616f758.jpg" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>电子设备商城</h3>
                                <p>登录注册（管理员表与用户表）、商品管理、用户管理、新品上市管理、无分页</p>
                            </div>
                            <div class="bottom">
                    ...
                    <li>
                        <a href="http://47.106.86.207/18_10_31_news/index.html" target="_blank">
                            <img alt="新闻网站" width="100%" src="http://47.106.86.207/18_10_31_news/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>新闻网站</h3>
                                <p>登录注册、新闻管理、发帖管理</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-cyan">2018-10-31</span></span>
                    ...
                    <li>
                        <a href="http://120.78.162.99/18-10-29/ybwy/index.php" target="_blank">
                            <img alt="留言板（管理员和普通用户）" height="124" width="100%" src="http://img.php.cn/upload/course/000/000/003/5a5099080616f758.jpg" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>留言板（管理员和普通用户）</h3>
                                <p>登录注册、用户管理、留言管理、案例管理</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-green">2018-10-29</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">40</span></span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="http://47.106.86.207/18_10_20/login.php" target="_blank">
                            <img alt="消防装备管理系统" height="124" width="100%" src="http://47.106.86.207/18_10_20/1.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>PHP+MySQL</i>消防装备管理系统</h3>
                                <p>管理员、员工、用户、个人信息管理、用户信息管理、分类信息管理、装备信息管理、出入库信息管理</p>
                            </div>
                            <div class="bottom">
                                <span class="l"><span class="layui-badge layui-bg-orange">2018-10-20</span></span>
                                <span class="r"> 1人使用&nbsp;&nbsp; 作业币：<span class="layui-badge">80</span></span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="http://47.106.86.207/faiqiyi/public/admin.php" target="_blank">
                            <img alt="仿爱奇艺系统后台功能" height="168" width="100%" src="http://47.106.86.207/faiqiyi/admin.png" style="display: inline-block;">
                            <div class="intro">
                                <h3><i>TP5.0.14</i>仿爱奇艺系统后台功能</h3>
                                <p>	登录以及退出功能、管理员管理、权限管理、系统设置、电影分类、电影列表、幻灯片管理</p>
                            </div>
                            <div class="bottom">
